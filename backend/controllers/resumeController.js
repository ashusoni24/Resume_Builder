...
export const createResume = async (req,res)=>{
    try {
        ...
        res.status(500).json({
            message : "Failed to create the resume",
            error : error.message
        })
    }
}

//Get function to get the resume
...
export const updateResume = async (req,res)=>{
    ...
    res.json(savedResume)
        ...
        res.status(500).json({
            message : "Failed to update the resume",
            error : error.message
        })
    }
